...
class CEMPlanning:
    ...
    def __init__(self, set_value, input_dim, output_dim, length=50, num_samples=32, max_iters=50, device='cpu', time=0):
        ...
        self.figs_path = os.path.join(os.getcwd(), 'control/cem_figs')
